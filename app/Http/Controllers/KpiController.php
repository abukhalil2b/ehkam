...
class KpiController extends Controller
{
    ...
    public function getReportSettings()
    {
        ...
        return response()->json([
            'success' => true,
            'data' => [
                'years' => KpiReportSetting::getSetting(
                    $userId,
                    'report_years',
    ...
    // ==========================================
    // إدارة السنوات (KpiYear Management)
    // ==========================================
     ...
     * عرض نموذج تعديل سنة
     */
    public function editYear(KpiYear $kpiYear)
    {
     ...
     * تحديث سنة
     */
    public function updateYear(Request $request, KpiYear $kpiYear)
    {
        $request->validate([
     ...
     * حذف سنة
     */
    public function destroyYear(KpiYear $kpiYear)
    {
        $kpiYear->delete();
        return redirect()->route('kpi-years.index')
    ...
    /**
     * تبديل حالة التنشيط للسنة
     */
    public function toggleYearActive(KpiYear $kpiYear)
    {
    ...
    /**
     * تحريك السنة للأعلى في الترتيب
     */
    public function moveYearUp(KpiYear $kpiYear)
    {
    ...
    /**
     * تحريك السنة للأسفل في الترتيب
     */
    public function moveYearDown(KpiYear $kpiYear)
    {
