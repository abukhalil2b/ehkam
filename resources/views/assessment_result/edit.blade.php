    ...
    <div class="container py-8 mx-auto px-4 max-w-4xl">
        ...
        <form method="POST" action="{{ route('assessment_result.update', $activity) }}"
            ...
            <div class="space-y-8">
                @forelse ($allQuestions as $question)
                    @php
                        ...
                        // Set the default value for the buttons/input
                    ...
                    <div
                        ...
                        <div class="mb-4 p-4 border rounded bg-white shadow-sm">
                            ...
                            @if ($question->type === 'range')
                                {{-- BUTTONS REPLACEMENT FOR RANGE INPUT --}}
                                <div class="flex flex-wrap gap-2" id="button_group_{{ $question->id }}">

                                    {{-- Loop to generate a button for each point from 1 up to max_point --}}
                                ...
                                <p class="text-xs text-gray-500 mt-2">
                                    (الحد الأقصى: {{ $question->max_point }}.)
                                </p>
            ...
            <div class="flex justify-end mt-8">
                <button type="submit"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-lg transition duration-150 shadow-lg text-lg">
                    حفظ التعديلات
                </button>
            </div>
        </form>
