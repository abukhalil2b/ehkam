...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="container mx-auto px-4 py-10">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-10">
            <div
                class="bg-gradient-to-r from-emerald-600 to-emerald-800 p-6 text-white flex justify-between items-center">
                <div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($userActivity as $index => $user)
                            <tr class="hover:bg-emerald-50 transition">
                                <td class="p-4">
                                    <div
                                        class="w-8 h-8 rounded-full bg-emerald-100 text-emerald-700 font-bold flex items-center justify-center text-sm">
                                        {{ $index + 1 }}
                                    </div>
                                </td>
                                <td class="p-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold">
                                ...
                                <td class="p-4 text-center">
                                    <span
                                        class="bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-bold inline-flex items-center gap-2">
                                        {{ $user->events_count }}
                                    </span>
                                </td>
                                <td class="p-4">
