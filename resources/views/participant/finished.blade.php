...
<body
    class="bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 min-h-screen flex items-center justify-center p-4">
            ...
            <div class="p-8 text-center">
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-6">
                    <div class="text-center">
                        <p class="text-gray-600 mb-2">نتيجتك النهائية</p>
                        <p class="text-5xl font-black text-blue-600">{{ $participant->score ?? 0 }} نقطة</p>
                    </div>
