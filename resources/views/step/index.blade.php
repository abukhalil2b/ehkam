<x-app-layout>
    ...
    {{-- ✅ Move CSS & JS CDN outside main container for best load timing --}}
    @push('styles')
    ...
    <script src="https://code.jquery.com/jquery-3.6.4.min.js"></script>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                $('#organizational_unit_id').select2({
            ...
            <form method="POST" action="{{ route('step.store', $project->id) }}"
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select id="organizational_unit_id" name="organizational_unit_id" class="w-full">
