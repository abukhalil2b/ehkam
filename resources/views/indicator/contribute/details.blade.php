                        ...
                        <tr class="hover:bg-gray-50 transition">
                         ...
                         بنسبة 110 %
                            ...
                            <td class="p-3 border">
                                ...
                                <input type="text" value="20" class="w-full p-2 border rounded-md text-right text-gray-800" dir="rtl">
                            </td>
                            <td class="p-3 border">
                                <div>المستهدف: 6000</div>
                                <input type="text" disabled class="bg-gray-200 w-full p-2 border rounded-md text-right text-gray-800" dir="rtl">
                            </td>
                            <td class="p-3 border">
