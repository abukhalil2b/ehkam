                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                             <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('workshop.export_attendance', ['workshop_id' => $selectedWorkshop->id, 'format' => 'xlsx']) }}" class="text-sm text-green-600 hover:text-green-800 font-medium transition flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                                        تصدير (Excel)
                                    </a>
                                    <span class="text-gray-300">|</span>
                                    <a href="{{ route('workshop.export_attendance', ['workshop_id' => $selectedWorkshop->id, 'format' => 'csv']) }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium transition flex items-center gap-1">
