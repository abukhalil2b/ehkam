<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-[#1e3d4f] to-[#2d5b7a] text-2xl text-white font-bold p-4 shadow-md">
        <h4 class="text-xl container mx-auto px-4">إدارة المشروعات لمؤشر:رفع نمو إيرادات الزكاة من خلال الوعي المجتمعي</h4>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="p-4 border-t border-gray-200 flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    عرض <span class="font-medium">1</span> إلى <span class="font-medium">2</span> من <span
                        class="font-medium">2</span> نتائج
                </div>
        ...
        <div x-show="open" @keydown.escape.window="open = false"
            ...
            <div class="bg-white w-full max-w-3xl rounded-lg shadow-xl overflow-hidden" x-show="open"
                ...
                <div class="bg-gradient-to-r from-[#1e3d4f] to-[#2d5b7a] text-white p-4">
                    <h3 class="text-lg font-bold">إضافة مشروع جديد</h3>
                </div>
                ...
                <div class="p-3">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div x-data="{ open: false, selected: [] }" class="relative">
                            ...
                            <div @click="open = !open"
                                class="w-full cursor-pointer flex flex-wrap items-center gap-1 border border-gray-300 rounded px-3 py-2 min-h-[42px] bg-gray-50">
                                <template x-if="selected.length === 0">
                                    <span class="text-gray-400 text-sm">اختر الدوائر</span>
                                </template>
                                <template x-for="item in selected" :key="item">
                                    <span
                                        class="bg-blue-100 text-blue-800 text-xs rounded-full px-2 py-1 flex items-center">
                                        <span x-text="item"></span>
                                        <button @click.stop="selected = selected.filter(i => i !== item)"
