    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-8">
                <h1 class="text-3xl font-bold mb-6 text-gray-800">إنشاء مشروع تحليل PESTLE</h1>

                <form action="{{ route('pestle.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="title" name="title" required maxlength="255"
                            class="w-full px-4 py-2 border border-blue-100 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('title') border-red-500 @enderror"
                            value="{{ old('title') }}"
                            placeholder="أدخل عنوان مشروع PESTLE (مثال: تحليل البيئة الخارجية 2026)">
                        @error('title')
